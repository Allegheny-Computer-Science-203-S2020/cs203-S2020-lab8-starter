...
TODO: Make sure that you copy over the `assessment.md` file from your previous
week. It should be clear that, for every week of the project, you are moving
closer to the :sunglasses: level of mastery for more of the technical and
professional skills in the field of software engineering. Please make sure that
you write a thoughtful paragraph for each skill for which you are providing an
assessment. If you have not provided an assessment, then the course instructor
will assume that you did not yet complete any work towards the mastery of that
skill. Please see the course instructor if you have questions about this process.
